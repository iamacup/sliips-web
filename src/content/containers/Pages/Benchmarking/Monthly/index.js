...
class Page extends React.Component {
  ...
  updateSalaryNumbers() {
    ...
    const low = Math.ceil((seedNumber - upperLower) / 100) * 100;
    const higher = Math.ceil((seedNumber + upperLower) / 100) * 100;
    const mid = Math.ceil(seedNumber / 100) * 100;
                        ...
                        <div className="col-xs-12">
                          ...
                          <div className="box-border">
                            ...
                            <div className="pull-right">
                              ...
                              >
                                <i className="fa fa-window-close" /> clear all
                              </button>
                            </div>
