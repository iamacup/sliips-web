...
import {
  DASHBOARD_INDUSTRY_DATA_START,
  DASHBOARD_INDUSTRY_DATA_SUCCESS,
  DASHBOARD_INDUSTRY_DATA_ERROR,
  DASHBOARD_INDUSTRY_DATA_FAILURE,
  DASHBOARD_INDUSTRY_DATA_RESET,
} from './action';
...
export default (state = initialState, action) => {
  switch (action.type) {
    case DASHBOARD_INDUSTRY_DATA_START:
      return _.assign({}, initialState, {
        started: true,
        finished: false,
        metaData: state.metaData,
      });
    case DASHBOARD_INDUSTRY_DATA_SUCCESS:
      return _.assign({}, initialState, {
    ...
    case DASHBOARD_INDUSTRY_DATA_ERROR:
      return _.assign({}, initialState, {
        payload: action.data.payload,
        statusCode: action.data.statusCode,
        generalStatus: 'error',
    ...
    case DASHBOARD_INDUSTRY_DATA_FAILURE:
      return _.assign({}, initialState, {
        generalStatus: 'fatal',
        started: false,
        finished: true,
    ...
    case DASHBOARD_INDUSTRY_DATA_RESET: {
