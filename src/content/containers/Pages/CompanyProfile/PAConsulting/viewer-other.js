              ...
              <div className="x_content">
                ...
                <div className="row text-center">
                  <div className="col-sm-8 col-sm-push-2">
                    ...
                    >
                      ...
                      others prefer salary and bonus, see what PA Consulting
                ...
                <div className="text-center">
                  ...
                  <h4 className="text-muted">
                    What's on the menu at PA Consulting?
                  </h4>
                </div>
                ...
                <div className="text-center">
                  ...
                  <div className="row flex-v-center-sm">
                    ...
                    <div className="col-sm-12 col-md-9" role="button">
                      <div
                        data-step="1"
                        data-intro="Press any part of the cake to see the benefits PA Consulting offers at different levels!"
                      >
                        <button
                          onClick={() => {
                            CompanyUtility.collapse('#icing');
                              ...
                              <div className="col-sm-12">
                                <div className="drop-shadow benefit-item-text-box-base round-corners">
                                  ...
                                  >
                                    ...
                                    available to all employees. In addition PA
                                    Consulting allows all employees to take up
                                    to 15 child care days a year unpaid.
                                  </h4>
                                </div>
                              </div>
                            </div>
